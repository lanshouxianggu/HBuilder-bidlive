...
@interface BidLiveHomeMainViewV2 : UIView
...
///cell上的正在直播点击block
@property (nonatomic, copy) void (^youlikeCellLivingClickBlock)(BidLiveHomeGuessYouLikeListModel *model);
///banner点击block
